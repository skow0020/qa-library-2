...
export default function InOfficeBook(props) {
  ...
  async function getBook() {
    ...
    await fetch(`${process.env.REACT_APP_MONGO_ENV_URL}/api/officeLibraryBooks/${office_book_id}`)
  ...
  const handleCheckout = (book_id) => {
    ...
    axios.patch(`${process.env.REACT_APP_MONGO_ENV_URL}/api/officeLibraryBooks/incrementCopiesCheckedOut`, checkoutBook)
      .then(
        data => {
  ...
  const handleCheckIn = (book_id) => {
    ...
    axios.patch(`${process.env.REACT_APP_MONGO_ENV_URL}/api/officeLibraryBooks/decrementCopiesCheckedOut`, checkinBook)
      .then(
        data => {
